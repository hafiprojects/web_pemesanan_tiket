...
<body>
   ...
   <div class="container">
      <nav class="navbar navbar-dark bg-dark">
         <a class="logo" href="index.php"><h1>HOME</h1></a>
               ...
               <div class="row">
                  <div class="col-md-6">
                     <div class="taital_main">
                        <p class="banner_text" style="color : #000000">Dalam hadis riwayat Imam Bukhari RA, Nabi Muhammad SAW menganjurkan para sahabatnya dan seluruh umat Islam yang mengikuti sunnahnya untuk menguasai berbagai bidang olahraga, terutama berkuda, berenang, dan memanah.Inilah saatnya kita berolahraga sunnah sesuai anjuran rasulullah SAW </p>
                        <div class="book_bt"><a href="pages/login.php" style="font-family: Arial, Helvetica, sans-serif;">Pembelian Tiket</a></div>
                     </div>
                  </div>
               </div>
            </div>
      ...
      <div class="category_section">
         <div class="row">
            ...
            <div class="col-lg-10 col-sm-12 main">
               <div class="col">
                  <div class="box_main">
                     <div class="images/memanah.jpeg"><img src="images/memanah.jpeg" alt="images/memanah.jpeg" height="70" width="70"></div>
