...
$article_data = $db->db_From_Id("SELECT * FROM article WHERE id = '$id'");

$photoPath = "";

if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST["submit"])) {
    $photoPath = $article_data[0]['thumbnail'];
    ...
    if (in_array($photoPath, ['ExtensionNotValid', 'ErrorUploadingFile', 'NoFileIncluded', 'MaxFileSizeExceeded'])) {
        ...
        $db->update_Artikel($judulArtikel, $slugArtikel, $detailArtikel, $status, $photoPath, $id);
    }
}
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">halaman edit artikel</p>
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="judulArtikel" class="form-control" id="judulArtikel" value="<?php echo $article_data[0]['title'] ?>" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleFormControlInput1">Slug Artikel : <span class="text-danger">*</span></label>
                                        <input type="text" name="slugArtikel" class="form-control" id="slugArtikel" value="<?php echo $article_data[0]['slug'] ?>" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleFormControlInput1">Detail Artikel : <span class="text-danger">*</span></label>
                                        <br>
                                        <div id="editor">
                                        <?php echo $article_data[0]['content'] ?> 
                                        </div>
                                        <input type="hidden" name="detailArtikel" id="detailArtikel" value="<?php echo $article_data[0]['title'] ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleFormControlSelect1">Status : <span class="text-danger">*</span></label>
                                        <select class="form-control" name="status" required>
                                            <option value="1" <?php $article_data[0]['is_published'] > 0 ? 'selected' : '' ?>>Di Publish</option>
                                            <option value="0" <?php $article_data[0]['is_published'] == 0 ? 'selected' : '' ?>>Di Arsip</option>
                                        </select>
                                    </div>
                                    <div class="form-group row mt-3">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="row ps-2 pe-2">
                                                <img src="../<?php echo $article_data[0]['thumbnail'] ?>" id="outputImage" class="photo" style="max-width: 500px;">
                                            </div>
                                        </div>
                                    </div>
