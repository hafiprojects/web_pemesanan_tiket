...
$banner_data = $db->db_From_Id("SELECT * FROM banner WHERE id = '$id'");

$photoPath = "";

if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST["simpan"])) {
    $photoPath = $banner_data[0]['image'];
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="row ps-2 pe-2">
                                                <img src="../<?php echo $banner_data[0]['image'] ?>" id="outputImage" class="photo" style="max-width: 500px;">
                                            </div>
                                        </div>
                                    </div>
